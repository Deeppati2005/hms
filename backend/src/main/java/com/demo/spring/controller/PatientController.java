...
public class PatientController {
	...
	public ResponseEntity<Patient> updatePatientProfile(@PathVariable String username,
			@RequestBody Patient updatedPatient) {
		Patient patient = patientService.updatePatientProfile(username, updatedPatient);
